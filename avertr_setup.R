...
setup_avertr <- function(rdf_directory_filepath, rdf_name_vector) {
  # DEFINE/LOAD OBJECTS ############
  ...
  # Set names
  ff_load_bin_data_final <- set_names(ff_load_bin_data_final, rdf_name_vector)
  
  
  # Set names
  nei_efs <- set_names(nei_efs, rdf_name_vector)
  ...
  interped_data_regions <- set_names(interped_data_regions, rdf_name_vector)
  
  return(lst(ff_load_bin_data_final, nei_efs, interped_data_regions))
