...
generate_reduction <- function(
  ...
  if (utility_storage_capacity_mw != 0 |
    ...
    # Left off here, wanted to check results of this against some actual results
    #   generated by AVERT, and then to go through line-by-line and run it to
    #   make sure I understand what's happening.

    # Allow for different durations (later, once you've confirmed that the
    #   above works)

    # Then I'd work on introducing blocking certain months/days
